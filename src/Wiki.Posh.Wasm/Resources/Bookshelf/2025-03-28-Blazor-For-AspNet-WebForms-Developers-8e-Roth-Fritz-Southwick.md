...
I don't think I'll be reading the other 3 [ebooks on .NET architecture](https://learn.microsoft.com/en-us/dotnet/architecture/), simply because the topics are not at all relevant to me. Containerisation, cloud-native, and Azure aren't really technologies I work with, nor do I see myself pivoting to work with them in the near future. That said, it's probably not the last book on software architecture I'll ever read. 